...
export const footerData = {
  links: [
    ...
    },
    {
      title: 'Service Areas',
      links: [
        { text: 'Holland, MI', href: getPermalink('/service-areas') },
        { text: 'Grand Rapids, MI', href: getPermalink('/service-areas') },
        { text: 'Byron Center, MI', href: getPermalink('/service-areas') },
        { text: 'Zeeland, MI', href: getPermalink('/service-areas') },
        { text: 'Saugatuck, MI', href: getPermalink('/service-areas') },
        { text: 'Hudsonville, MI', href: getPermalink('/service-areas') },
        { text: 'Allegan, MI', href: getPermalink('/service-areas') },
      ],
    },
  ],
  secondaryLinks: [
